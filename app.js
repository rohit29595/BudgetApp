...
var UIController = (function(){
    ...
    return{
        ...
        addListItem : function(obj,type){
            ...
            //exp_percentage = (obj.value/budgetController.data.totals[obj.type])*100;
...
var controller = (function(budgetCtrl, UICtrl){
    ...
    var setupEventListeners = function(){
        ...
        document.getElementById('graph').addEventListener('click',toggleChart);
    ...
    var ctrlAddItem = function(){
        ...
        // 1. Get input data from the text fields
